...
public class TF2Attribute {
	...
	public static final Predicate<ItemStack> ITEM_BULLET=new Predicate<ItemStack>(){
		...
		public boolean apply(ItemStack input) {
			// TODO Auto-generated method stub
			return input.getItem() instanceof ItemBulletWeapon;
		}
	...
	public static final Predicate<ItemStack> EXPLOSIVE=new Predicate<ItemStack>(){
		...
		public boolean apply(ItemStack input) {
			// TODO Auto-generated method stub
			return input.getItem() instanceof ItemProjectileWeapon&&!(ItemFromData.getData(input).getString(PropertyType.PROJECTILE).equals("syringe")||input.getItem() instanceof ItemFlameThrower);
		}
	...
	public static void initAttributes(){
		new TF2Attribute(0, "DamageBonus", "Damage", AttributeType.PERCENTAGE, 1f, AttributeState.POSITIVE, ITEM_WEAPON,0.25f,4,160,3);
		new TF2Attribute(1, "DamagePenalty", "Damage", AttributeType.PERCENTAGE, 1f, AttributeState.NEGATIVE, ITEM_WEAPON,0.15f,2,-9,1);
		...
		new TF2Attribute(6, "FireRateBonus", "Fire Rate", AttributeType.INVERTED_PERCENTAGE, 1f, AttributeState.POSITIVE, NOT_FLAMETHROWER,-0.1f,4,80,3);
		...
		new TF2Attribute(31, "BurnTimeBonus", "Burn Time", AttributeType.PERCENTAGE, 1f, AttributeState.POSITIVE, FLAMETHROWER,0.5f,4,140,2);
		new TF2Attribute(32, "BurnTimePenalty", "Burn Time", AttributeType.PERCENTAGE, 1f, AttributeState.NEGATIVE, FLAMETHROWER,-0.5f,4,1,2);
	...
	public String getTranslatedString(float value,boolean withColor){
		...
		if(withColor){
			EnumChatFormatting color=this.state == AttributeState.POSITIVE ? EnumChatFormatting.AQUA : (this.state == AttributeState.NEGATIVE ? EnumChatFormatting.RED : EnumChatFormatting.WHITE);
	...
	public static List<TF2Attribute> getAllPassibleAttributesForUpgradeStation(){
		...
		for(TF2Attribute attr:MapList.nameToAttribute.values()){
			if(attr.canApply!=Predicates.<ItemStack>alwaysFalse()&&attr.state==AttributeState.POSITIVE){
