...
public class WeaponData {
	...
	public static class PropertyType{
		...
		public void deserialize(ByteBuf buf,WeaponData data){
			data.properties.put(this, new Property());
			switch (type){
				case BOOLEAN:data.properties.get(this).booleanValue=buf.readBoolean();break;
				case INTEGER:data.properties.get(this).intValue=new PacketBuffer(buf).readVarIntFromBuffer();break;
				case DOUBLE:data.properties.get(this).floatValue=buf.readFloat();break;
				case STRING:int stringLength=buf.readByte();
				data.properties.get(this).stringValue=buf.toString(buf.readerIndex(),stringLength, StandardCharsets.UTF_8);
