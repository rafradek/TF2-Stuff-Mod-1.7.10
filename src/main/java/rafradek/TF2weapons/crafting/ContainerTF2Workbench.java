...
public class ContainerTF2Workbench extends Container
{
    ...
    public ContainerTF2Workbench(EntityPlayer player,InventoryPlayer playerInventory, World worldIn, int x, int y, int z)
    {
    	this.player=player;
    ...
    {
        return this.worldObj.getBlock(this.x,this.y,this.z) != TF2weapons.blockCabinet ? false : playerIn.getDistanceSq(this.x + 0.5D, this.y + 0.5D, this.z + 0.5D) <= 64.0D;
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            if(itemstack1.getItem()==TF2weapons.itemTF2&&itemstack1.getItemDamage()==9){
        		itemstack1=ItemFromData.getRandomWeapon(playerIn.getRNG(),ItemFromData.VISIBLE_WEAPON);
        	}
        	else if(itemstack1.getItem()==TF2weapons.itemTF2&&itemstack1.getItemDamage()==10){
        		itemstack1=ItemFromData.getRandomWeaponOfClass("cosmetic",playerIn.getRNG());
        	}
